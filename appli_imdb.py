...
acteurs_series = data_series['Acteurs'].str.split(',').explode()
...
if st.sidebar.checkbox('Durée du film'):
    ...
    with data_filtered :
        mask_to_display = data_films['time_cleaned'] < duree_max_films
    st.success("RESULTAT - Voici la liste des films concernés :")
    st.dataframe(data=data_films[mask_to_display])
    st.write("Soit un total de",len(data_films[mask_to_display]),"films.")
...
if st.sidebar.checkbox('Note du film'):
    ...
    with data_filtered :
        mask_to_display = data_films['Note'] > note_min_films
    st.success("RESULTAT - Voici la liste des films concernés :")
    st.dataframe(data=data_films[mask_to_display])
    st.write("Soit un total de",len(data_films[mask_to_display]),"films.")
...
if st.sidebar.checkbox("Durée moyenne d'un épisode"):
    ...
    with data_filtered :
        mask_to_display = data_series['time_cleaned'] < duree_max_series
    st.success("RESULTAT - Voici la liste des séries concernées :")
    st.dataframe(data=data_series[mask_to_display])
    st.write("Soit un total de",len(data_series[mask_to_display]),"séries.")
...
if st.sidebar.checkbox("Nombre d'épisodes total"):
    ...
    with data_filtered :
        mask_to_display = data_series["Nombre d'épisodes"] < episodes_max_series
    st.success("RESULTAT - Voici la liste des séries concernées :")
    st.dataframe(data=data_series[mask_to_display])
    st.write("Soit un total de",len(data_series[mask_to_display]),"séries.")
...
if st.sidebar.checkbox('Note de la série'):
    ...
    with data_filtered :
        mask_to_display = data_series['Note'] > note_min_series
    st.success("RESULTAT - Voici la liste des séries concernées :")
    st.dataframe(data=data_series[mask_to_display])
    st.write("Soit un total de",len(data_series[mask_to_display]),"séries.")
